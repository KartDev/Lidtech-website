...
export const checklistConfig = {
  ...
  form: {
    ...
    compactButtonLabel: "Request the checklist ->",
    note: "For now this opens an email draft while the mailing list and automated download flow are being set up.",
    submittedMessage:
      "If your mail app did not open, email contact@lidtech.se and mention the checklist.",
  },
  sectionHeading: {
